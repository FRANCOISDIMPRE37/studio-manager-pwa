...
export const DOCUMENT_LABELS: Record<DocumentType, string> = {
  // Piercing — Mineurs
  questionnaire_mineur: '01 — Dossier Complet Mineur / Autorisation Parentale / Piercing',
  ...
  // Tatouage
  questionnaire_tatouage_mineur: '05 — Dossier Complet Mineur / Autorisation Parentale / Tatouage',
  ...
  // Dermographie
  questionnaire_dermographe_mineur: '10 — Dossier Complet Mineur / Autorisation Parentale / Dermographie',
